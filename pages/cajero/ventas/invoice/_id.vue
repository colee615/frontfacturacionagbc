               ...
               <div class="col-lg-8 mx-auto">
                  <div class="card mb-4">
                     ...
                     <div class="card-body p-3 pt-0">
                        ...
                        <div class="row">
                           <div class="col-12" v-for="m in model.detalle_ventas">
                              <div class="d-flex">
                                       ...
                                       <span class="mb-2 text-xs">Cliente:
                                          <span class="text-dark font-weight-bold ms-2">{{
                                             model.cliente.codigoCliente }} - {{
                                                model.cliente.razonSocial }}</span>

                                       </span>
                                       <span class="mb-2 text-xs">Documento Identidad:
                                          <span class="text-dark font-weight-bold ms-2">{{
                                             model.cliente.documentoIdentidad }}</span>
                                       </span>
                                       <span class="mb-2 text-xs">Cajero:
                                          <span class="text-dark font-weight-bold ms-2">{{ model.cajero.name }}</span>
                                       </span>
                                    </div>
                                 </li>
                              </ul>
